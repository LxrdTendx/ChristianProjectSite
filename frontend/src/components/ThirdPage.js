    ...
    return(
        <div className='thirdpage'>
            <div className='left-block'>
                <div className='text-link-third'>[ о настоятеле ]</div>
                <div className='third-page-name'>Иеромонах Стефан</div>
            </div>
            <div className='right-block'>
                <p><span className='third-text-color'>Иеромонах Стефан</span> - насельник Николо-Угрешского монастыря</p>
